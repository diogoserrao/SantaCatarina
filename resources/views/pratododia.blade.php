    ...
    <div class="daily-special-container">
        ...
        <div class="dish-container status-active">
            ...
            <div class="dish-info">
                ...
                <div class="dish-description">
                    <p>Mas não se preocupe — hoje temos um delicioso Prego no Prato com bife suculento, batatas fritas crocantes, arroz branco e ovo estrelado. Uma opção prática e saborosa!</p>
                </div>
                <div class="dish-price">
